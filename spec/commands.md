...
- 12: Set Speaker Rolloff Settings
  same as `Set Listener Rolloff Settings` but we can override it per speaker
    ...
    - **rolloffStart (f32)**
    - **rolloffEnd (f32)**
- 19: Reset Speaker Data - unsets the `Speaker Position`, `Speaker Flags`, and `Rolloff Settings`
      <!-- Audio Effects 20-39 -->
...
- 10: Speaker Volumes Updated
    - **totalSpeakers (u16)**
    - **volumes\[totalSpeakers\] (u8)**: - **speakerId (u16)** - **volume (u8)**: volume going from 0 to 255
        <!-- In-Game Settings Control (for optionally embedding Proxa's settings into the game) 30-49 -->
- 30: Options Recieved
